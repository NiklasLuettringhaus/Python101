...
# Da im PDF der Button nicht angezeigt wird, binden 
# wir hier ein Bild von einem Button ein, dieses Bild
# erscheint im PDF. Das Modul "pdfimage" ist selbst
# geschrieben, den Quellcode kannst du in den Kurs-
# materialien einsehen.

from pdfimage import PdfImage

PdfImage("./resources/button.png", 0.4)
...
PdfImage("./resources/form.png", 0.6)
