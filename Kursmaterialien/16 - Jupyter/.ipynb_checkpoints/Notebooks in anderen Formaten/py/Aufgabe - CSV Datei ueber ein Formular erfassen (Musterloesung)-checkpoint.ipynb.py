...
# 
# Verwende für den Vornamen bzw. den Nachnamen ein Textfeld, und für das Studienfach ein Auswahlmenü, mit dem das Studienfach ausgewählt werden kann. Erstelle dann einen Button, mit dem der aktuelle Studierende in die .csv - Datei geschrieben wird, und über das Formular anschließend der nächste Studierende erfasst werden kann.
